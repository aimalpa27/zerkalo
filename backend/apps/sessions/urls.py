...
from .views import (
    ...
    SLAIncidentListView,
    OperationsExceptionsView,
    SessionOperationsTimelineView,
    ServiceRecoveryView, ServiceRecoveryDetailView,
    StaffAddItemsView,
    StaffPlaceOrderView,
)
...
urlpatterns = [
    ...
    path('restaurants/<uuid:rest_id>/sla-incidents/', SLAIncidentListView.as_view(), name='sla-incidents'),
    path('restaurants/<uuid:rest_id>/operations/exceptions/', OperationsExceptionsView.as_view(), name='operations-exceptions'),
    path('restaurants/<uuid:rest_id>/sessions/<uuid:session_id>/timeline/', SessionOperationsTimelineView.as_view(), name='session-operations-timeline'),
    path('restaurants/<uuid:rest_id>/sessions/<uuid:session_id>/service-recoveries/', ServiceRecoveryView.as_view(), name='service-recoveries'),
    path('restaurants/<uuid:rest_id>/sessions/<uuid:session_id>/service-recoveries/<uuid:recovery_id>/', ServiceRecoveryDetailView.as_view(), name='service-recovery-detail'),

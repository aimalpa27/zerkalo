...
class TableSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'service_charge_amount', 'delivery_fee', 'loyalty_discount_amount', 'total_amount',
            'payment_method',
        ...
        read_only_fields = [
            ...
            'delivery_fee', 'loyalty_discount_amount', 'total_amount', 'created_at', 'updated_at',
        ]
...
class PlaceOrderItemSerializer(serializers.Serializer):
    menu_item_id = serializers.UUIDField()
    upsell_rule_id = serializers.UUIDField(required=False, allow_null=True)
...
class PlaceOrderSerializer(serializers.Serializer):
    ...
    loyalty_token = serializers.UUIDField(required=False, allow_null=True)
    redeem_loyalty = serializers.BooleanField(required=False, default=False)

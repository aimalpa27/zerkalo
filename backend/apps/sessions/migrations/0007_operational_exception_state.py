...
class Migration(migrations.Migration):
    dependencies = [
        ('order_sessions', '0006_sla_incidents'),
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='operationalexceptionstate',
            constraint=models.UniqueConstraint(fields=('restaurant', 'exception_key'), name='uniq_restaurant_exception_key'),
        ),
        migrations.AddIndex(
            model_name='operationalexceptionstate',
            index=models.Index(fields=['restaurant', 'resolved_at'], name='operationa_restaur_2a7438_idx'),
        ),
        migrations.AddIndex(
            model_name='operationalexceptionstate',
            index=models.Index(fields=['restaurant', 'kind'], name='operationa_restaur_42a17a_idx'),
        ),
    ]

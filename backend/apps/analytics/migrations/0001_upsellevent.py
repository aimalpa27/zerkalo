...
class Migration(migrations.Migration):
    initial = True
    dependencies = [('menu', '0005_upsellrule'), ('restaurants', '0001_initial'), ('sessions', '0001_initial'), ('tables', '0001_initial')]
    operations = [migrations.CreateModel(name='UpsellEvent', fields=[
        ...
        ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='upsell_events', to='sessions.tablesession')),

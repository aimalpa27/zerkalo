...
from apps.analytics.views import AnalyticsSessionsView, AnalyticsSummaryView, NetworkAnalyticsView, NetworkListCreateView, NetworkMembershipView
from .views import (
    RestaurantBySlugView,
    RestaurantCoverUploadView,
    RestaurantDetailView,
    RestaurantDiagnosticsView,
...
urlpatterns = [
    ...
    path('networks/<uuid:network_id>/analytics/', NetworkAnalyticsView.as_view(), name='network-analytics'),
    path('networks/<uuid:network_id>/members/', NetworkMembershipView.as_view(), name='network-members'),
    ...
    path('<uuid:rest_id>/diagnostics/', RestaurantDiagnosticsView.as_view(), name='restaurant-diagnostics'),

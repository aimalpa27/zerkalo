...
| Full order lifecycle regression | P0 | Critical | L | 1–2d | runtime deps | RUNTIME PASS 2026-09-20 — 14/14 critical regression tests pass QR→menu→cart→order→admin→kitchen→ready→waiter→served→close→analytics; Cycle 56 removes the final midnight-sensitive full-suite fixture |

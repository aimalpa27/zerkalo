...
python manage.py test config.test_health -v 2
...
python manage.py test apps.users apps.restaurants apps.menu apps.tables apps.sessions apps.calls apps.analytics apps.loyalty apps.websocket -v 1

...
export type TabId = 'sessions' | 'menu' | 'staff' | 'analytics' | 'tables' | 'calls' | 'delivery' | 'schedule' | 'chat' | 'diagnostics' | 'network' | 'loyalty' | 'exceptions'
export type Period = 'today' | 'week' | 'month' | 'custom'
export type AppScreen = 'mode' | 'auth' | 'loading' | 'app' | 'demo'
